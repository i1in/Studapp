    ...
    return (
        <>
            ...
            <div className="layout">
                <nav className="menu">
                    <a href="/search" className="menu-item active">
                        <span className="icon">
                ...
                <main className="content">
                    <div className="search-input-wrapper">
                        <p className="search-header">Поиск студента</p>
                        <input
                            ref={inputRef}
                            type="text"
                    ...
                    {isLoading && <p className="search-loading">Идет поиск...</p>}
                    {error && <p className="search-error">{error}</p>}

                    <ul className="search-results">
                        {results.map((user) => (
                            <li key={user.id} className="search-result-item">
                                <Link to={`/${user.username || user.id}`} className="search-result-link">
                                    ...
                                    <div className="post-author__name">
                                        <a href={`${user.username}`} className="author-name__url">
