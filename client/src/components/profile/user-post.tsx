...
function UserPost() {
    ...
    return (
        <div className="post-upload">
            <p className="section-title">Новая заметка</p>
            <div className="post-upload__inputs">
                <div className="upload-content">
                    <div className="upload-inputs__row">
                        <input
                            type="text"
                    ...
                    <p className="file-counter">
                        {fileCount === 0
                            ...
                            : fileCount === 1
                                ? 'Выбран 1 файл'
                                : `Выбрано ${fileCount} файлов`}
                    </p>
                </div>
                <ErrorMessage error={errorMsg} />
                <div className="post-button">
                    <button
                        className="post-button__wrapper"
                        onClick={handleSubmit}
                        disabled={content.length === 0}>
                        <p className="post-button__text">Опубликовать</p>
                    </button>
                </div>
            </div>
        </div>
